const properties = [
  {id:1,price:475000,title:'3 bedroom semi-detached house',location:'Bristol, BS7',beds:3,baths:2,area:'1,245 sq ft',epc:'B',tenure:'Freehold',council:'Band D',parking:'Driveway',garden:'Rear garden',score:null,tag:'Featured',status:'Featured',image:'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?auto=format&fit=crop&w=1600&q=90'},
  {id:2,price:625000,title:'2 bedroom apartment',location:'London, SE1',beds:2,baths:2,area:'885 sq ft',epc:'C',tenure:'Leasehold',council:'Band F',parking:'Permit',garden:'Shared',score:null,tag:'City living',status:'New',image:'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1600&q=90'},
  {id:3,price:385000,title:'4 bedroom detached house',location:'Leeds, LS16',beds:4,baths:2,area:'1,890 sq ft',epc:'C',tenure:'Freehold',council:'Band E',parking:'Garage + drive',garden:'Large rear garden',score:null,tag:'Family home',status:'Available',image:'https://images.unsplash.com/photo-1605146769289-440113cc3d00?auto=format&fit=crop&w=1600&q=90'},
  {id:4,price:510000,title:'3 bedroom townhouse',location:'Manchester, M20',beds:3,baths:2,area:'1,430 sq ft',epc:'B',tenure:'Freehold',council:'Band D',parking:'Allocated',garden:'Private garden',score:null,tag:'Garden',status:'Available',image:'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?auto=format&fit=crop&w=1600&q=90'},
  {id:5,price:795000,title:'4 bedroom period home',location:'Bath, BA1',beds:4,baths:3,area:'2,240 sq ft',epc:'D',tenure:'Freehold',council:'Band G',parking:'On-street',garden:'Courtyard',score:null,tag:'Period',status:'New',image:'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&w=1600&q=90'},
  {id:6,price:295000,title:'2 bedroom cottage',location:'York, YO31',beds:2,baths:1,area:'925 sq ft',epc:'C',tenure:'Freehold',council:'Band C',parking:'Driveway',garden:'Rear garden',score:null,tag:'Character',status:'Available',image:'https://images.unsplash.com/photo-1510798831971-661eb04b3739?auto=format&fit=crop&w=1600&q=90'}
];
...
@media(max-width:680px){html{scroll-padding-top:78px}.hero-content{padding:70px 0 38px}.hero-copy{max-width:none}.hero-sub{font-size:17px;margin-bottom:26px}.search-card{padding:12px;border-radius:18px}.search-tabs{overflow-x:auto;white-space:nowrap;scrollbar-width:none}.search-tabs::-webkit-scrollbar{display:none}.search-tab{flex:0 0 auto}.quick-links{overflow-x:auto;flex-wrap:nowrap;scrollbar-width:none;padding-bottom:2px}.quick-links::-webkit-scrollbar{display:none}.quick-links button{flex:0 0 auto}.neighbourhood-grid{grid-template-columns:1fr;grid-template-rows:auto;gap:16px}.area-card,.area-card:first-child{grid-column:auto;grid-row:auto;min-height:280px}.area-card:first-child{min-height:310px}.area-content{left:18px;right:18px;bottom:18px}.area-content strong{font-size:27px}.section-head .outline-btn{width:100%}.property-card{border-radius:18px}.property-image{height:230px}.property-info{padding:16px}.price{font-size:23px}.property-facts{gap:10px;flex-wrap:wrap}.site-header{position:sticky;top:0}.modal{padding:12px}.modal-panel{padding:24px 18px;border-radius:20px}.modal-panel h2{font-size:34px}.compare-tray{gap:9px;padding:10px}.compare-tray>div:first-child{min-width:0}.compare-tray strong{font-size:12px}.compare-go{padding:9px 10px}.compare-clear{padding:7px}.detail-score{margin-top:10px}}
`;
...
function propertyDetail(p){
  const confidence=p.score==null?'Pending':`${p.score}/100`;
  const meter=p.score==null?0:p.score;
  modalEyebrow.textContent='PROPERTY INTELLIGENCE';modalTitle.textContent=p.title;modalText.innerHTML=`<div class="detail-wrap"><div><img class="detail-image" src="${p.image}" alt="${p.title}"><div class="detail-price">${pound(p.price)}</div><div class="detail-meta">${p.location} · ${p.beds} bedrooms · ${p.baths} bathrooms · ${p.area}</div><div class="detail-facts"><div class="detail-fact"><b>Tenure</b><small>${p.tenure}</small></div><div class="detail-fact"><b>EPC</b><small>Band ${p.epc}</small></div><div class="detail-fact"><b>Council tax</b><small>${p.council}</small></div><div class="detail-fact"><b>Parking</b><small>${p.parking}</small></div></div></div><div><div class="detail-score"><small>PROPERTY CONFIDENCE</small><div><strong>${confidence}</strong></div><div class="meter"><span style="width:${meter}%"></span></div><div class="detail-checks"><span>✓ Price shown</span><span>✓ Tenure shown</span><span>✓ EPC shown</span><span>✓ Council tax shown</span><span>• Evidence layer</span><span>• Live verification</span></div></div><p style="margin-top:16px">Confidence is evidence-derived in the production property flow. This demo listing remains pending until authoritative evidence is matched.</p></div></div>`;aiBrief.value='';modalAction.textContent='Add to comparison →';modalAction.dataset.detailId=p.id;modalAction.dataset.action='compare';modalResult.hidden=true;
}
